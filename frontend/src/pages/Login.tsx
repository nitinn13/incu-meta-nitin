...
const Login = () => {
  ...
  const handleDemoLogin = async () => {
    try {
      setIsSubmitting(true);
      setEmail("contact@innovatex.org");
      setPassword("secure123");
      
      await login("contact@innovatex.org", "secure123");
            ...
            <form onSubmit={handleSubmit}>
              ...
              <CardFooter className="flex flex-col space-y-4 pt-2">
                ...
                <p className="text-sm text-center text-gray-600 pt-2">
                  ...
                  <Link to="/register" className="text-gray-800 hover:text-black font-medium transition-colors">
                    Create account
                  </Link>
                </p>
              </CardFooter>
